...
class Budget {
    ...
    static async setBudgetDetails(token, id) {
        ...
        Budget.renderRecordCategories(recordCategories, budget.recordCategories)
     ...
     */
    static renderRecordCategories(recordCategories, selectedRecordCategories) {
        ...
        recordCategories.forEach((recordCategory) => {
            ...
            updateBudgetRecordCategoriesDropdown.innerHTML += `<div class="form-check">
                ${input}
